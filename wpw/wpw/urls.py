...
urlpatterns = [
    ...
    path('tribes/all-tribes', tribes_views.all_tribes, name='all_tribes'),
    ...
    path('tribes/<int:id>/', tribes_views.tribe_view, name='profile_view'),
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='users/request_password_reset.html'),
